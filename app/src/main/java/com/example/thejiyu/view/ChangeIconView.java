package com.example.thejiyu.view;
...
public class ChangeIconView extends View {
    ...
    public ChangeIconView(Context context, AttributeSet attrs)
    {
                                   ...
                                   int defStyleAttr)
    {
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            switch (attr)
            {
                case R.styleable.ChangeIcon_iconx:
                    BitmapDrawable drawable = (BitmapDrawable) a.getDrawable(attr);
                    mIconBitmap = drawable.getBitmap();
                    break;
                case R.styleable.ChangeIcon_colorx:
